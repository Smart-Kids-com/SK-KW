...
const items = [
  { title: "الصفحة الرئيسية", Link: "https://smartkidskw.com" }, // صفحة البداية
  { title: "اكتشف أحدث إصداراتنا للأطفال", Link: "https://smartkidskw.com/collections/${collection.handle}" },
