...
const items = [
  ...
  { title: "اكتشف أحدث إصداراتنا للأطفال", href: "اكتشف-أحدث-إصداراتنا-للأطفال" },
  { title: "تسوّق جميع منتجاتنا الآن", href: "تسوّق-جميع-منتجاتنا-الآن" },
  ...
  { title: "عروض القصص التفاعلية", href: "عروض-القصص-التفاعلية" },
  ...
  { title: "الأفضل مبيعاً", href: "smart-kids-kuwait-الأفضل-مبيعاً-الأطفال-المبتكرون-الكويت" },
