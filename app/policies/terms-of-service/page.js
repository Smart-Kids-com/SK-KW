// app/policies/terms-of-service/page.js
...
export default async function TermsOfServicePage() {
  // فعّل السحب من شوبيفاي بوضع USE_SHOPIFY_POLICIES=1 في .env.local
  const useShopify = process.env.USE_SHOPIFY_POLICIES === "1";

  const data = useShopify
    ? await getPolicyByHandleShopify("terms-of-service")
    : getPolicyByHandle("terms-of-service");
