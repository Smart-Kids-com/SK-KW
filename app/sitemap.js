...
export default async function sitemap() {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/pages/about-us`,              lastModified: new Date(), changeFrequency: 'monthly',priority: 0.5 },
    { url: `${baseUrl}/pages/contact-us`,            lastModified: new Date(), changeFrequency: 'monthly',priority: 0.5 },
    ...
    { url: `${baseUrl}/policies/contact-information`,   lastModified: new Date(), changeFrequency: 'monthly',priority: 0.4 },
  ];
