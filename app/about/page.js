...
<style>
  ...
  *,*:before,*:after{box-sizing:border-box}
  ...
  /* =============== STATS (الكروت الأربع) =============== */
  /* وسّعنا الشبكة على الديسكتوب لـ 4 أعمدة كاملة */
  .stats{display:grid;grid-template-columns:repeat(4,2fr);gap:22px;margin:34px 0 8px}
  ...
  /* مربع الصورة يملأ الكارت ويوفّق الأبعاد */
  ...
  /* يطبق فقط على الأيقونات اللي داخل كروت القيم */
.section .card > .icon {
...
<br><strong>قِصَصٌ تُربّي وتُلهم</strong><br>
</div>
<h2 style="text-align: right;">
<span style="color: rgb(13, 99, 40);">نُقَدِّمُ مُحْتَوًى تَعْلِيمِيًّا مُمتِعًا لِلأَطْفَالِ</span><br><span style="color: rgb(13, 99, 40);">نَوَّعْنَا التَّعْلِيمَ فَابْتَكَرْنَا الْمُتْعَةَ</span>
</h2>
<h6 class="lead" style="text-align: right;"><strong>في الأطفال المبتكرون <span style="color: rgb(8, 40, 14);">نؤمن أن القراءة رحلة تبدأ بسؤال صغير. نقدّم منتجات تعليمية مبتكرة وترفيهية للأطفال، بتركيز على تنمية المهارات اللغوية والحركية والعقلية، ومحتوى عربيّ عالي الجودة يُنمّي الفضول والخيال، ويُسعد الأطفال والأهل معًا.</span></strong></h6>
...
<div class="btns">
<a href="https://smart-kids.me" class="btn">تسوّق الآن</a> <a href="https://smart-kids.me/policies/contact-information" class="btn ghost">تواصل معنا</a>
</div>
</div>
</div>
</section>
<!-- الإحصائيات (الأربع كروت) -->
...
<h3><span style="color: rgb(0, 0, 0);">جودة مادية وتصميمية</span></h3>
<p class="muted"><strong><span style="color: rgb(0, 0, 0);">ورق متين، طباعة زاهية، وتجربة استخدام مدروسة تناسب أيدي الصغار.</span></strong></p>
</div>
<div class="card">
<div class="icon">2</div>
<h3><span style="color: rgb(0, 0, 0);">محتوى عربي أصيل</span></h3>
<p><strong>قصص وأنشطة باللغة العربية تُحاكي واقع الطفل وتُعزّز لغته وهويته.</strong></p>
</div>
<div class="card">
<div class="icon">3</div>
<h3><span style="color: rgb(0, 0, 0);">تعلم تفاعلي ممتع</span></h3>
...
<!-- STORY / TIMELINE -->
<section class="section">
<h2><span style="color: rgb(0, 0, 0);"><strong>حكاية الأطفال المبتكرون</strong></span></h2>
<div class="card">
<div class="timeline">
<div class="step">
<div class="dot">1</div>
...
<div class="row">
<a class="btn" href="https://wa.me/" rel="noopener" target="_blank">تحدث معنا الآن</a> <a class="btn ghost" href="https://smart-kids.me/policies/contact-information">معلومات التواصل</a>
</div>
</div>
</section>
<!-- FOOT -->
...
<b><br></b>
<div class="ph" style="aspect-ratio: 16/7; border-radius: 12px; overflow: hidden;"><img src="https://cdn.shopify.com/s/files/1/0697/3318/7805/files/Logo_smart_kids-of-header-tag.png?v=1756574543" alt="شعار الموقع" style="width: 100%; height: auto;"></div>
<p class="muted" style="margin: 0;"><br></p>
<div class="row" style="display: flex; gap: 10px; flex-wrap: wrap;">
<a class="btn ghost" href="mailto:Kuwait-info@smart-kids.me">Kuwait-info@smart-kids.me</a> <a class="btn ghost" href="/policies/shipping-policy">سياسة الشحن</a> <a class="btn ghost" href="/policies/refund-policy">الاسترجاع والاستبدال</a>
</div>
</div>
</section>
</section>
