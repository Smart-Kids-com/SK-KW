// app/ar/products/[handle]/page.js
...
export default async function ProductPageAR({ params }) {
  ...
  if (!product && /[^\u0000-\u007F]/.test(rawHandle)) {
    ...
    if (best?.handle && best.handle !== rawHandle) {
      redirect(`/ar/products/${encodeURIComponent(best.handle)}`);
    }
  }
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/ar" style={{ color: "#9422af", textDecoration: "none" }}>
          الرئيسية
        </Link>
