...
function EmailSubscribeBox() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
      // لو عندك API جاهز للاشتراك، فك الكود ده وبدّل الرابط:
      ...
      // حالياً: نجاح شكلي آمن لا يتعارض مع الـAuth
  ...
  return (
    <>
      ...
      {status === "err" && (
        <div style={{ marginTop: '10px', color: '#ffd2d2', textAlign: 'center', fontSize: '0.95rem' }}>
          تحقق من البريد ✋
        </div>
      )}
    </>
...
export default function Footer() {
  return (
    <footer style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center' }}>
              {/* روابط السوشيال تبعك كما هي (شغالة) */}
              <a href="https://www.facebook.com/KuwaitSmartKids" style={{ color:'rgba(255,255,255,0.8)', textDecoration:'none', display:'flex', alignItems:'center', gap:'0.5rem', fontSize:'1.1rem' }}>
              ...
              <a href="https://www.instagram.com/kuwaitsmartkids/" style={{ color:'rgba(255,255,255,0.8)', textDecoration:'none', display:'flex', alignItems:'center', gap:'0.5rem', fontSize:'1.1rem' }}>
                <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" style={{ display:'block' }}>
                  <path fill="currentColor" d="M7 2h10c2.761 0 5 2.239 5 5v10c0 2.761-2.239 5-5 5H7c-2.761 0-5-2.239-5-5V7c0-2.761 2.239-5 5-5zm5 5a5 5 0 110 10 5 5 0 010-10zm5.5-.75a1.25 1.25 0 11-2.5 0 1.25 1.25 0 012.5 0z"/>
                </svg>
                Instagram
              </a>
              <a href="https://www.youtube.com/@SmartKids-Gulf" style={{ color:'rgba(255,255,255,0.8)', textDecoration:'none', display:'flex', alignItems:'center', gap:'0.5rem', fontSize:'1.1rem' }}>
                <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" style={{ display:'block' }}>
              ...
              <a href="https://www.tiktok.com/@smartkids.gulf" style={{ color:'rgba(255,255,255,0.8)', textDecoration:'none', display:'flex', alignItems:'center', gap:'0.5rem', fontSize:'1.1rem' }}>
              ...
              <a href="https://www.pinterest.com/smartkidsgulf" style={{ color:'rgba(255,255,255,0.8)', textDecoration:'none', display:'flex', alignItems:'center', gap:'0.5rem', fontSize:'1.1rem' }}>
                <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" style={{ display:'block' }}>
              ...
              <a href="https://www.snapchat.com/add/smart.kidskw" style={{ color:'rgba(255,255,255,0.8)', textDecoration:'none', display:'flex', alignItems:'center', gap:'0.5rem', fontSize:'1.1rem' }}>
                <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" style={{ display:'block' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ marginBottom: '1.5rem' }}>
              <img 
                ...
                style={{ width: '180px', height: 'auto', filter: 'brightness(1.2)', marginBottom: '1rem' }}
              />
            </div>
            <div style={{ fontSize: '1.1rem', fontWeight: '600', marginBottom: '0.5rem' }}>smartkidskw.com</div>
            <div style={{ fontSize: '1rem', fontWeight: '500', marginBottom: '0.5rem' }}>INNOVATORS GULF TRADING W.L.L</div>
            <div style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.8)' }}>All Rights Reserved - جميع الحقوق محفوظة</div>
          </div>

          {/* Left Side - Email Subscription */}
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '1rem', marginBottom: '1rem', color: 'rgba(255,255,255,0.9)' }}>
      ...
      {/* Footer Links */}
      <div style={{ borderTop: '1px solid rgba(122, 1, 175, 0.1)', padding: '1.5rem 2rem' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap', fontSize: '0.85rem' }}>
            <Link href="/refund-policy" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>سياسة الإرجاع</Link>
            <Link href="/privacy-policy" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>سياسة الخصوصية</Link>
            <Link href="/terms-of-service" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>شروط الخدمة</Link>
            <Link href="/shipping-policy" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>سياسة الشحن</Link>
            <Link href="/about" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>من نحن</Link>
            <Link href="/contact-information" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>اتصل بنا</Link>
          </div>
        </div>
