...
export default function Header() {
  ...
  return (
    <>
      ...
      <header dir="rtl" style={{ width: "100%", position: "sticky", top: 0, zIndex: 50, background: "#fff", boxShadow: "var(--sk-header-shadow)" }}>
        {/* شريط العرض */}
        <Link
          href="/collections"
          className="sk-topbar"
        ...
        >
          ...
          <div className="sk-actions" style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <Link href="/cart" aria-label="عربة التسوق"><CartIcon /></Link>
          </div>
        </div>
      </header>
